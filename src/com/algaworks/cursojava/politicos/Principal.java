...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Cargo governador = new Cargo();
		governador.setDescricao("Governador");
		governador.setSalario(new BigDecimal(30000) );
		...
		//adiciona Governador
		politico = new Politico();
		politico.setNome("Ruy Correria");
		politico.setCargo(governador);
		...
		BigDecimal gastosPT = governo.calcularGastosComSalario("PT");
		System.out.println("Gastos com partido PT: " + formatador.format(gastosPT.doubleValue()));
